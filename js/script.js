...
function showResult() {
    ...
    if (userScore > 16) {
        ...
        let scoreTag = '<span>Kerja bagus 😎, Kamu menjawab <p>' + userScore + '</p> dari <p>' + questions.length + '</p></span>';
        scoreText.innerHTML = scoreTag;
    } else {
        let scoreTag = '<span>Terus belajar 😐, Kamu menjawaby <p>' + userScore + '</p> dari <p>' + questions.length + '</p></span>';
        scoreText.innerHTML = scoreTag;
    }
